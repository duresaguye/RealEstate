        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Specializing in luxury real estate properties in the most prestigious locations worldwide.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/neighborhoods" className="text-muted-foreground hover:text-primary">
                  Neighborhoods
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-muted-foreground">info@luxuryestate.com</span>
              </li>
            </ul>
          </div>
          <div>
